package com.yyms.api.kyn.application.jwtsecurity;
...
/*
* ** Read JWT authentication token from Authorization Header
** Check or validate token
** Load User (Get User Profile or Get Products or Search Products) 
** Parse it to Spring Security 

*** Spring Security uses SecurityContext in the controller 
